...
export function ManualAttendanceModal({
  ...
  const [status, setStatus] = useState<"present" | "absent">(defaultStatus);
        ...
        >
          <ScrollView showsVerticalScrollIndicator={false}>
            <View className="p-6">
              ...
              {/* Session Info */}
              <View className="bg-blue-50 rounded-lg p-3 border border-blue-200 mb-6">
                ...
                >
                  <View className="flex-row items-center justify-center">
                    ...
                    <Text className="text-white font-bold ml-2">
                      {isLoading ? `Marking ${status}...` : `Mark as ${status}`}
                    </Text>
                  </View>
                </Pressable>
              </View>
